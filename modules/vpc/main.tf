...
# vpc association - disabled done on portal
...
#Private subnets - disabled done on portal
...
# DB Private subnets - disabled done on portal
...
# Route tables - disabled done on portal
